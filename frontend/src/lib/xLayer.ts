...
const marketContractAddress = process.env.NEXT_PUBLIC_CREDPLAY_MARKET_CONTRACT_ADDRESS || "";
...
export const credPlayMarketContractAddress = marketContractAddress as Address;

export function hasXLayerWalletConfig() {
  return Boolean(chainId && rpcUrl && usdtAddress && marketContractAddress);
}
