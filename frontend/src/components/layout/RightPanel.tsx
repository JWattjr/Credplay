          ...
          {trending.length > 0 ? trending.map((item) => {
            ...
            >
              <span className="font-mono text-[10px] font-black uppercase tracking-[0.16em] text-[var(--muted)]">
                Trending in {market?.category || "Predictions"}
              </span>
            ...
            {predictors.length > 0 ? predictors.map((user) => (
              ...
              >
                ...
                <div className="flex flex-col items-end">
                  <span className="text-sm font-black text-brand-secondary">Active</span>
                  <span className="font-mono text-[10px] uppercase text-[var(--muted)]">Predictor</span>
                </div>
              </div>
            )) : (
