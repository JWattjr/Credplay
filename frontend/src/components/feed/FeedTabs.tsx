      ...
      {FEED_TABS.map((tab) => {
        ...
        return (
          <button
            ...
            className={`group relative flex h-11 items-center justify-center rounded-[13px] text-xs font-black uppercase tracking-[0.12em] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-secondary focus-visible:ring-inset ${
